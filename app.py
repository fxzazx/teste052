...
# Configuração do bot do Discord com interactions.py
...
# Função para rodar o bot e a API simultaneamente
async def main():
    try:
        # Iniciar o bot do Discord em uma task
